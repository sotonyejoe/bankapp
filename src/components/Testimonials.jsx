...
const Testimonials = () => (
  ...
  <section id="clients" className={`${styles.paddingY} ${styles.flexCenter} flex-col relative`}>
    <div className="absolute z-0 w-[60%] h-[60%] -right-[60%] rounded-full bg-blue-gradient blur-3xl opacity-15"  />
    ...
    <div className="flex flex-wrap sm:jusitfy-start justify-center w-full feedback-container relatice z-[1]">
      {feedback.map((card) => (
